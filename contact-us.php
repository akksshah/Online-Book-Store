...
<body>
                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                <li>
                                    <a href="#">
                                        <i class="fa fa-phone"></i> +1 9699 669 012</a>
                                </li>
                                <li>
                                    <a href="#">
                                        <i class="fa fa-envelope"></i> akks.shah1997@gmail.com</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="logo pull-left">
                            <a href="index.html">
                                <img height="20px" width="40px;" src="images/final/home/Untitled-35png.png" alt="images/final/home/Untitled-35png.png" />
                            </a>
                        </div>
    ...
    <div id="contact-page" class="container">
        <div class="bg">
            <div class="row">
                <div class="col-sm-12">
                    <h2 class="title text-center">Contact
                        <strong>Us</strong>
                    </h2>
                    <div class="banner_bottom_agile_info team">
                        <div class="container">
                            <h3 class="wthree_text_info col-sm-12 title text-center" font-color:"orange";>Our Team
                                <span>Members</span>
                            </h3>
                ...
                <div class="row">
                    <div class="col-sm-2">
                        <div class="single-widget">
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                <li>
                                    <a href="404.html">Online Help</a>
                                </li>
                                <li>
                                    <a href="404.html">Contact Us</a>
                                </li>
                                <li>
                                    <a href="404.html">Order Status</a>
                                </li>
                                <li>
                                    <a href="404.html">Change Location</a>
                                </li>
                                <li>
                    ...
                    <div class="col-sm-2">
                        <div class="single-widget">
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                <li>
                                    <a href="404.html">T-Shirt</a>
                                </li>
                                <li>
                                    <a href="404.html">Mens</a>
                                </li>
                                <li>
                                    <a href="404.html">Womens</a>
                                </li>
                                <li>
                                    <a href="404.html">Gift Cards</a>
                                </li>
                                <li>
                                    <a href="404.html">Shoes</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-2">
                        <div class="single-widget">
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li>
                                    <a href="404.html">Privecy Policy</a>
                                </li>
                                <li>
                                    <a href="404.html">Refund Policy</a>
                                </li>
                                <li>
                                    <a href="404.html">Billing System</a>
                                </li>
                                <li>
                                    <a href="404.html">Ticket System</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-2">
                        <div class="single-widget">
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                <li>
                                    <a href="404.html">Company Information</a>
                                </li>
                                <li>
                                    <a href="404.html">Careers</a>
                                </li>
                                <li>
                                    <a href="404.html">Store Location</a>
                                </li>
                                <li>
                                    <a href="404.html">Affillate Program</a>
                                </li>
                                <li>
                                    <a href="404.html">Copyright</a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <p class="pull-right">Designed by
                        <span>
							<a target="_blank" href="https://linkedin.com/in/aakashdshah/">Hriti Aakash Shanay</a>
						</span>
                    </p>
                </div>
            </div>
